...
## Project Structure
    ...
    ├── summer_snowflake_de_87018  # Django project configurations
...
1. Clone this repo and `cd summer_snowflake_de_87018`
...
2. Clone this repo and `cd summer_snowflake_de_87018`
